...
<script>var jsArr = <?php echo json_encode($_POST);?>;</script>
...
<form action="checkDomain.html" method="POST">
	<div id="container">
		<table>
			<tr>
				<td align="center">
					<p id="zaglav">Проверка доменного имени</p>
					<p><input type="text" id="domain_name" name="domain_name" value="<?php echo $_POST['domain_name']; ?>"></p>
